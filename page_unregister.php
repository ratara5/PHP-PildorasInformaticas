...
<?php
    ...
    echo "<br><div id='id1'>Ahora una consulta de BORRAR desde formulario login<br>";
    $query="DELETE FROM datospersonales WHERE nombre='$username' AND clave='$password'";
    //$query=$query="DELETE FROM datospersonales WHERE nombre='$username' AND clave='$password' OR '1'='1'"; //INYECCIÓN DE SQL USADA EN EL IMPUT DEL FORMULARIO -> ' OR '1'='1 . MUY PELIGROSO: Pues borra todo
    echo "$query<br>"; //Mostrar la consulta (solicitud) que se está haciendo

    $set=mysqli_query($connection,$query); 
    //show_set($set); No requerida para DELETE
